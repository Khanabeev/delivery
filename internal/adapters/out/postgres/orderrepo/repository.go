...
// Эта строка гарантирует на этапе компиляции, что структура Repository
// реализует все методы интерфейса ports.OrderRepository.
// Если Repository не реализует какой-либо метод из интерфейса,
